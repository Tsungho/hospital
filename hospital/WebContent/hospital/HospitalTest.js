...
var docter = [];
docter.push(new Doctor('01', '안성호', '123456-1234567', 'so7247@naver.com', '서울시 종로구 평창동', '정신과'));
docter.push(new Doctor('02', '이요한', '123456-1234567', 'safxza@naver.com', '서울시 강남구 ', '성형외과'));
docter.push(new Doctor('03', '이문규', '123456-1234567', 'sqweq@naver.com', '서울시 구로구 고척동', '외과'));
